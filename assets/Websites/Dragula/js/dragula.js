...
function main() {
      var Frans = document.getElementById("Frans");
      var fransjes = document.getElementById("fransjes");
      Frans.onmouseover = function() {
            fransjes.classList.add("franszichtbaar");
            fransjes.classList.remove("fransonzichtbaar");
      }
      Frans.onmouseout = function() {
            fransjes.classList.add("fransonzichtbaar");
            fransjes.classList.remove("franszichtbaar");
      }
      fransjes.onmouseover = function() {
            fransjes.classList.add("franszichtbaar");
            fransjes.classList.remove("fransonzichtbaar");
      }
      fransjes.onmouseout = function() {
            fransjes.classList.add("fransonzichtbaar");
            fransjes.classList.remove("franszichtbaar");
      }
      var Rekenen = document.getElementById("Rekenen");
      var rekentjes = document.getElementById("rekentjes");
      Rekenen.onmouseover = function() {
            rekentjes.classList.add("rekenenzichtbaar");
            rekentjes.classList.remove("rekenenonzichtbaar");
      }
      Rekenen.onmouseout = function() {
            rekentjes.classList.add("rekenenonzichtbaar");
            rekentjes.classList.remove("rekenenzichtbaar");
      }
      rekentjes.onmouseover = function() {
            rekentjes.classList.add("rekenenzichtbaar");
            rekentjes.classList.remove("rekenenonzichtbaar");
      }
      rekentjes.onmouseout = function() {
            rekentjes.classList.add("rekenenonzichtbaar");
            rekentjes.classList.remove("rekenenzichtbaar");
      }
      var Taal = document.getElementById("Taal");
      var taaltjes = document.getElementById("taaltjes");
      Taal.onmouseover = function() {
            taaltjes.classList.add("taalzichtbaar");
            taaltjes.classList.remove("taalonzichtbaar");
      }
      Taal.onmouseout = function() {
            taaltjes.classList.add("taalonzichtbaar");
            taaltjes.classList.remove("taalzichtbaar");
      }
      taaltjes.onmouseover = function() {
            taaltjes.classList.add("taalzichtbaar");
            taaltjes.classList.remove("taalonzichtbaar");
      }
      taaltjes.onmouseout = function() {
            taaltjes.classList.add("taalonzichtbaar");
            taaltjes.classList.remove("taalzichtbaar");
      }
